...
> Snapshot 1
    ...
    `<p><icon attr3="my attribute" attr2="my-attr" class="my-class" id="my-id" attr="default"></icon></p>␊
    `
...
> Snapshot 1
    ...
    `<h1>Alpha</h1>␊
    <p><span class="custom-alert" id="my-alert"><i class="fa fa-exclamation" aria-hidden="true"></i><span>My message!</span><span class="subtext">my subtext is rad</span></span></p>␊
    <h2>Bravo</h2>␊
    <h2>Delta</h2>␊
    `
